...
import Controller.hendle_duocKhenThuong;
import DAO.Duoc;
import DAO.dang_ky;
 ...
 * @author Aspire3
 */
public class pnSinhVienDuocKhenThuong extends javax.swing.JFrame {
    DefaultTableModel model;
    hendle_duocKhenThuong main = new hendle_duocKhenThuong();
    private String maSV = "";
    private String maKT = "";
    /**
     * Creates new form pnQuanlyDangKyHoc
     */
    public pnSinhVienDuocKhenThuong() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thêm Sinh Viên Được Khen Thưởng");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Sinh Viên", "Tên Sinh Viên", "Mã Khen Thưởng", "Danh Hiệu", "Ngày Khen Thưởng"
            }
        ));
        ...
        jLabel3.setText("Mã Khen Thưởng:");
        ...
        kGradientPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(kGradientPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, 307, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        if (
          !txtMaSinhVien.getText().equals("")
            ...
            if (maKT.equals(null)) {
                ...
                maKT = String.valueOf(jComboBox1.getSelectedItem());
            }
            Duoc dc = new Duoc(txtMaSinhVien.getText(), maKT);
            if (main.createDKT(dc)) {
                JOptionPane.showMessageDialog(rootPane, "Thêm Sinh Viên Được Khen Thưởng Thành Công!");
                 renderData();
            }else {
                JOptionPane.showMessageDialog(rootPane, "Thêm Sinh Viên Được Khen Thưởng Không Thành Công!");
            }
        }else {
    ...
    private void kButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton5ActionPerformed
        ...
        MessageFormat  header = new MessageFormat("Danh Sách Sinh Viên Được Khen Thưởng");
    ...
    private void kButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton6ActionPerformed
       if (
          !txtMaSinhVien.getText().equals("")
           ...
           Duoc dc = new Duoc(txtMaSinhVien.getText(), maKT);
            if (main.updateDKT(dc)) {
                JOptionPane.showMessageDialog(rootPane, "Cập Nhật Sinh Viên Được Khen Thưởng Thành Công!");
                 renderData();
            }else {
                JOptionPane.showMessageDialog(rootPane, "Cập Nhật Sinh Viên Được Khen Thưởng Không Thành Công!");
            }
        }else {
            JOptionPane.showMessageDialog(rootPane, "Các Thông Tin Không Được Rỗng");
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        String makt = jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString();
        txtMaSinhVien.setText(maSV);
        var dsMKT = main.getMaKT();
        int cnt = -1;
        for (var it : dsMKT) {
            cnt++;
            if (makt.equals(it)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pnSinhVienDuocKhenThuong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pnSinhVienDuocKhenThuong().setVisible(true);
            }
        });
    }
    ...
    private void renderData() {
       ...
       model.getDataVector().removeAllElements();// Xóa toàn bộ bảng ghi
        ...
        try {
            ...
            Logger.getLogger(pnSinhVienDuocKhenThuong.class.getName()).log(Level.SEVERE, null, ex);
        }
