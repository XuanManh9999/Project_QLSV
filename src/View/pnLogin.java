...
public class pnLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kButton3.setkHoverEndColor(new java.awt.Color(102, 255, 51));
        ...
        kGradientPanel1.add(kButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 350, 130, -1));
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        ...
        if (txtusername.getText().toLowerCase().equals("admin") && txtpassword.getText().toLowerCase().equals("123")) {
           ...
           JOptionPane.showMessageDialog(rootPane, "Đăng Nhập Không Thành Công, vui lòng kiểm tra tài khoản và mật khẩu.");
        }
